...
export default class DungeonScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio('theme', ['../assets/music/Scorching Desert - Pokémon Mystery Dungeon.mp3', '../assets/music/Scorching-Desert-Pokémon-Mystery-Dungeon.ogg']);
  ...
  create() {
    ...
    //input.onDown.add(changeVolume, this);
